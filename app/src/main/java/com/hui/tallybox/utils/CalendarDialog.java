...
import com.hui.tallybox.adapter.CalendarAdapter;
...
public class CalendarDialog extends Dialog implements View.OnClickListener {
    ...
    private void addViewToLayout() {
        ...
        if (selectPos == -1) {
            selectPos = hsvViewList.size()-1;     //默认设置当前被选中的为最近的年份
        }
    ...
    private void changeTvbg(int selectPos) {
        ...
        selView.setBackgroundResource(R.drawable.main_recordbtn_bt);
